    ...
    <section className="bg-white py-20 px-4">
      <div className="mx-auto max-w-5xl space-y-12">
        <div className="text-center space-y-3">
          ...
          <p className="text-gray-500 max-w-xl mx-auto">Built for speed, privacy, and accuracy — from a single image to a production-ready prompt.</p>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((f) => (
            <div key={f.title} className="rounded-2xl border border-gray-100 bg-gray-50 p-6 space-y-3 hover:border-violet-200 hover:bg-violet-50/30 transition-colors">
              <div className="inline-flex items-center justify-center w-10 h-10 rounded-xl bg-violet-100">
                {f.icon}
              </div>
